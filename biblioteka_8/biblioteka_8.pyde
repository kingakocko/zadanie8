...
def setup():
    ...
    global library, Kinga
    books = ["Naocznosc", "Sens Sztuki", "Harry Potter", "IT"]
...
def mouseClicked(): 
    if mouseX >100 and mouseX<200:
        if mouseY >10 and mouseY <30:
            ...
            library.lendBook(Madzia.requestBook("IT"))
        if mouseY >40 and mouseY <60:
            library.addBook(Madzia.returnBook())
            library.addBook(Kinga.returnBook())#powtarzanie warunkó to zła praktyka
